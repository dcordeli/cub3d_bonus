...
void			ft_pars_t_help(t_pars *p, char *s)
{
	if (s[0] == 'N' && (p->f & F_NO) == 0)
		...
		p->f |= F_SO;
	else if (s[0] == 'S' && s[1] == '1' && (p->f & F_S1) == 0)
		p->f |= F_S1;
	else if (s[0] == 'S' && s[1] == '2' && (p->f & F_S2) == 0)
		p->f |= F_S2;
	else if (s[0] == 'S' && s[1] == '3' && (p->f & F_S3) == 0)
		p->f |= F_S3;
	else if (s[0] == 'S' && s[1] == '4' && (p->f & F_S4) == 0)
		p->f |= F_S4;
	else if (s[0] == 'S' && s[1] == '5' && (p->f & F_S5) == 0)
		p->f |= F_S5;
	else if (s[0] == 'S' && s[1] == '6' && (p->f & F_S6) == 0)
		p->f |= F_S6;
	else if (s[0] == 'S' && s[1] == '7' && (p->f & F_S7) == 0)
		p->f |= F_S7;
	else if (s[0] == 'S' && s[1] == '8' && (p->f & F_S8) == 0)
		p->f |= F_S8;
}
...
void			ft_pars_t(t_pars *p, char *str, t_list **head)
{
	...
	{
		ft_pars_t_help(p, s[0]);
		ft_pars_t_path(p, s[0], s[1]);
		free(s[0]);
		free(s);
	}
}
